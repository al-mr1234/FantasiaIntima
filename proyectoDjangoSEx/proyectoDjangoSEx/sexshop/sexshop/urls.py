...
from sexshop.views import LadingPage,listadocategorias,insertarcategorias,borrarcategoria,actualizarcategoria, perfiles, crudCategorias, crudSubCategorias, crudProductos, crudDomiciliarios, login, registro, recuperarContraseña 
